...
const BIRDS = [
  { id: 1, lot: 1, name: "Rouge-gorge familier", wiki: "https://fr.wikipedia.org/wiki/Rouge-gorge_familier", images: [
  ...
  { id: 2, lot: 1, name: "Mésange bleue", wiki: "https://fr.wikipedia.org/wiki/Mésange_bleue", images: [
  ...
  { id: 3, lot: 1, name: "Merle noir", wiki: "https://fr.wikipedia.org/wiki/Merle_noir", images: [
  ...
  { id: 4, lot: 1, name: "Moineau domestique", wiki: "https://fr.wikipedia.org/wiki/Moineau_domestique", images: [
  ...
  { id: 5, lot: 1, name: "Pigeon ramier", wiki: "https://fr.wikipedia.org/wiki/Pigeon_ramier", images: [
  ...
  { id: 6, lot: 1, name: "Mésange charbonnière", wiki: "https://fr.wikipedia.org/wiki/Mésange_charbonnière", images: [
  ...
  { id: 7, lot: 1, name: "Chardonneret élégant", wiki: "https://fr.wikipedia.org/wiki/Chardonneret_élégant", images: [
  ...
  { id: 8, lot: 1, name: "Pinson des arbres", wiki: "https://fr.wikipedia.org/wiki/Pinson_des_arbres", images: [
  ...
  { id: 9, lot: 1, name: "Étourneau sansonnet", wiki: "https://fr.wikipedia.org/wiki/Étourneau_sansonnet", images: [
  ...
  { id: 10, lot: 1, name: "Corneille noire", wiki: "https://fr.wikipedia.org/wiki/Corneille_noire", images: [
  ...
  { id: 11, lot: 1, name: "Pie bavarde", wiki: "https://fr.wikipedia.org/wiki/Pie_bavarde", images: [
  ...
  { id: 12, lot: 1, name: "Tourterelle turque", wiki: "https://fr.wikipedia.org/wiki/Tourterelle_turque", images: [
  ...
  { id: 13, lot: 1, name: "Verdier d'Europe", wiki: "https://fr.wikipedia.org/wiki/Verdier_d'Europe", images: [
  ...
  { id: 14, lot: 1, name: "Rougequeue noir", wiki: "https://fr.wikipedia.org/wiki/Rougequeue_noir", images: [
  ...
  { id: 15, lot: 1, name: "Troglodyte mignon", wiki: "https://fr.wikipedia.org/wiki/Troglodyte_mignon", images: [
  ...
  { id: 16, lot: 1, name: "Accenteur mouchet", wiki: "https://fr.wikipedia.org/wiki/Accenteur_mouchet", images: [
  ...
  { id: 17, lot: 1, name: "Fauvette à tête noire", wiki: "https://fr.wikipedia.org/wiki/Fauvette_à_tête_noire", images: [
  ...
  { id: 18, lot: 1, name: "Pigeon biset (urbain)", wiki: "https://fr.wikipedia.org/wiki/Pigeon_biset", images: [
  ...
  { id: 19, lot: 1, name: "Serin cini", wiki: "https://fr.wikipedia.org/wiki/Serin_cini", images: [
  ...
  { id: 20, lot: 1, name: "Bergeronnette grise", wiki: "https://fr.wikipedia.org/wiki/Bergeronnette_grise", images: [
  ...
  { id: 21, lot: 1, name: "Hirondelle rustique", wiki: "https://fr.wikipedia.org/wiki/Hirondelle_rustique", images: [
  ...
  { id: 22, lot: 1, name: "Hirondelle de fenêtre", wiki: "https://fr.wikipedia.org/wiki/Hirondelle_de_fenêtre", images: [
  ...
  { id: 23, lot: 1, name: "Martinet noir", wiki: "https://fr.wikipedia.org/wiki/Martinet_noir", images: [
    "https://commons.wikimedia.org/wiki/Special:FilePath/Apus_apus_01.jpg?width=500"
  ]},
  { id: 24, lot: 1, name: "Choucas des tours", wiki: "https://fr.wikipedia.org/wiki/Choucas_des_tours", images: [
  ...
  { id: 25, lot: 1, name: "Corbeau freux", wiki: "https://fr.wikipedia.org/wiki/Corbeau_freux", images: [
  ...
  { id: 26, lot: 2, name: "Mésange noire", wiki: "https://fr.wikipedia.org/wiki/Mésange_noire", images: [
  ...
  { id: 27, lot: 2, name: "Mésange nonnette", wiki: "https://fr.wikipedia.org/wiki/Mésange_nonnette", images: [
    "https://commons.wikimedia.org/wiki/Special:FilePath/Parus_palustris02.jpg?width=500"
  ]},
  { id: 28, lot: 2, name: "Mésange huppée", wiki: "https://fr.wikipedia.org/wiki/Mésange_huppée", images: [
  ...
  { id: 29, lot: 2, name: "Mésange à longue queue", wiki: "https://fr.wikipedia.org/wiki/Mésange_à_longue_queue", images: [
  ...
  { id: 30, lot: 2, name: "Sittelle torchepot", wiki: "https://fr.wikipedia.org/wiki/Sittelle_torchepot", images: [
  ...
  { id: 31, lot: 2, name: "Grimpereau des jardins", wiki: "https://fr.wikipedia.org/wiki/Grimpereau_des_jardins", images: [
  ...
  { id: 32, lot: 2, name: "Grimpereau des bois", wiki: "https://fr.wikipedia.org/wiki/Grimpereau_des_bois", images: [
  ...
  { id: 33, lot: 2, name: "Roitelet huppé", wiki: "https://fr.wikipedia.org/wiki/Roitelet_huppé", images: [
  ...
  { id: 34, lot: 3, name: "Roitelet à triple bandeau", wiki: "https://fr.wikipedia.org/wiki/Roitelet_à_triple_bandeau", images: [
    "https://commons.wikimedia.org/wiki/Special:FilePath/Regulus_ignicapilla_Arundel.jpg?width=500"
  ]},
  { id: 35, lot: 3, name: "Pouillot véloce", wiki: "https://fr.wikipedia.org/wiki/Pouillot_véloce", images: [
  ...
  { id: 36, lot: 3, name: "Pouillot fitis", wiki: "https://fr.wikipedia.org/wiki/Pouillot_fitis", images: [
  ...
  { id: 37, lot: 3, name: "Pouillot de Bonelli", wiki: "https://fr.wikipedia.org/wiki/Pouillot_de_Bonelli", images: [
    "https://commons.wikimedia.org/wiki/Special:FilePath/Phylloscopus_bonelli_2.jpg?width=500"
  ]},
  { id: 38, lot: 3, name: "Fauvette grisette", wiki: "https://fr.wikipedia.org/wiki/Fauvette_grisette", images: [
    "https://commons.wikimedia.org/wiki/Special:FilePath/Sylvia_communis_(Dorngrasm%C3%BCcke)_2013-08-15_01.jpg?width=500"
  ]},
  { id: 39, lot: 3, name: "Fauvette des jardins", wiki: "https://fr.wikipedia.org/wiki/Fauvette_des_jardins", images: [
  ...
  { id: 40, lot: 3, name: "Fauvette babillarde", wiki: "https://fr.wikipedia.org/wiki/Fauvette_babillarde", images: [
    "https://commons.wikimedia.org/wiki/Special:FilePath/Fauvette_babillarde._-_Flickr_-_Ferdinand23.jpg?width=500"
  ]},
  { id: 41, lot: 3, name: "Fauvette mélanocéphale", wiki: "https://fr.wikipedia.org/wiki/Fauvette_mélanocéphale", images: [
  ...
  { id: 42, lot: 3, name: "Locustelle tachetée", wiki: "https://fr.wikipedia.org/wiki/Locustelle_tachetée", images: [
  ...
  { id: 43, lot: 4, name: "Pic épeiche", wiki: "https://fr.wikipedia.org/wiki/Pic_épeiche", images: [
  ...
  { id: 44, lot: 4, name: "Pic vert", wiki: "https://fr.wikipedia.org/wiki/Pic_vert", images: [
  ...
  { id: 45, lot: 4, name: "Pic mar", wiki: "https://fr.wikipedia.org/wiki/Pic_mar", images: [
    "https://commons.wikimedia.org/wiki/Special:FilePath/Dendrocopos_medius_(Marek_Szczepanek).jpg?width=500"
  ]},
  { id: 46, lot: 4, name: "Pic noir", wiki: "https://fr.wikipedia.org/wiki/Pic_noir", images: [
  ...
  { id: 47, lot: 4, name: "Pic épeichette", wiki: "https://fr.wikipedia.org/wiki/Pic_épeichette", images: [
    "https://commons.wikimedia.org/wiki/Special:FilePath/Dendrocopos_minor_291108.jpg?width=500"
  ]},
  { id: 48, lot: 4, name: "Torcol fourmilier", wiki: "https://fr.wikipedia.org/wiki/Torcol_fourmilier", images: [
  ...
  { id: 49, lot: 5, name: "Grive musicienne", wiki: "https://fr.wikipedia.org/wiki/Grive_musicienne", images: [
  ...
  { id: 50, lot: 5, name: "Grive draine", wiki: "https://fr.wikipedia.org/wiki/Grive_draine", images: [
  ...
  { id: 51, lot: 5, name: "Grive litorne", wiki: "https://fr.wikipedia.org/wiki/Grive_litorne", images: [
  ...
  { id: 52, lot: 5, name: "Grive mauvis", wiki: "https://fr.wikipedia.org/wiki/Grive_mauvis", images: [
  ...
  { id: 53, lot: 5, name: "Merle à plastron", wiki: "https://fr.wikipedia.org/wiki/Merle_à_plastron", images: [
  ...
  { id: 54, lot: 6, name: "Faucon crécerelle", wiki: "https://fr.wikipedia.org/wiki/Faucon_crécerelle", images: [
  ...
  { id: 55, lot: 6, name: "Buse variable", wiki: "https://fr.wikipedia.org/wiki/Buse_variable", images: [
  ...
  { id: 56, lot: 6, name: "Épervier d'Europe", wiki: "https://fr.wikipedia.org/wiki/Épervier_d'Europe", images: [
  ...
  { id: 57, lot: 6, name: "Milan noir", wiki: "https://fr.wikipedia.org/wiki/Milan_noir", images: [
  ...
  { id: 58, lot: 6, name: "Milan royal", wiki: "https://fr.wikipedia.org/wiki/Milan_royal", images: [
  ...
  { id: 59, lot: 6, name: "Busard Saint-Martin", wiki: "https://fr.wikipedia.org/wiki/Busard_Saint-Martin", images: [
  ...
  { id: 60, lot: 6, name: "Busard cendré", wiki: "https://fr.wikipedia.org/wiki/Busard_cendré", images: [
  ...
  { id: 61, lot: 6, name: "Bondrée apivore", wiki: "https://fr.wikipedia.org/wiki/Bondrée_apivore", images: [
  ...
  { id: 62, lot: 6, name: "Autour des palombes", wiki: "https://fr.wikipedia.org/wiki/Autour_des_palombes", images: [
  ...
  { id: 63, lot: 6, name: "Faucon hobereau", wiki: "https://fr.wikipedia.org/wiki/Faucon_hobereau", images: [
  ...
  { id: 64, lot: 6, name: "Aigle botté", wiki: "https://fr.wikipedia.org/wiki/Aigle_botté", images: [
