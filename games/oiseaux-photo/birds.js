...
// Toutes les images ci-dessous ont été vérifiées comme existant réellement sur Wikimedia Commons.
// Certaines espèces n'ont que 2 images (pas trouvé de 3e fichier propre au moment de la vérification).

const BIRDS = [
  { id: 1, name: "Rouge-gorge familier", images: [
  ...
  { id: 2, name: "Mésange bleue", images: [
  ...
  { id: 4, name: "Moineau domestique", images: [
  ...
  { id: 5, name: "Pigeon ramier", images: [
  ...
  { id: 6, name: "Mésange charbonnière", images: [
  ...
  { id: 7, name: "Chardonneret élégant", images: [
  ...
  { id: 8, name: "Pinson des arbres", images: [
  ...
  { id: 9, name: "Étourneau sansonnet", images: [
  ...
  { id: 10, name: "Corneille noire", images: [
  ...
  { id: 12, name: "Tourterelle turque", images: [
  ...
  { id: 13, name: "Verdier d'Europe", images: [
  ...
  { id: 14, name: "Rougequeue noir", images: [
  ...
  { id: 15, name: "Troglodyte mignon", images: [
  ...
  { id: 16, name: "Accenteur mouchet", images: [
  ...
  { id: 17, name: "Fauvette à tête noire", images: [
  ...
  { id: 18, name: "Pigeon biset (urbain)", images: [
  ...
  { id: 20, name: "Bergeronnette grise", images: [
  ...
  { id: 21, name: "Hirondelle rustique", images: [
  ...
  { id: 22, name: "Hirondelle de fenêtre", images: [
  ...
  { id: 25, name: "Corbeau freux", images: [
  ...
  // Lot 2/7 — Mésanges, sittelle, grimpereaux + roitelet à triple bandeau
  { id: 26, name: "Mésange noire", images: [
  ...
  { id: 29, name: "Mésange à longue queue", images: [
  ...
  { id: 30, name: "Sittelle torchepot", images: [
  ...
  { id: 31, name: "Grimpereau des jardins", images: [
  ...
  { id: 32, name: "Grimpereau des bois", images: [
  ...
  { id: 33, name: "Roitelet huppé", images: [
  ...
  { id: 36, name: "Pouillot fitis", images: [
  ...
  { id: 42, name: "Locustelle tachetée", images: [
  ...
  { id: 49, name: "Grive musicienne", images: [
  ...
  { id: 50, name: "Grive draine", images: [
  ...
  { id: 51, name: "Grive litorne", images: [
  ...
  { id: 52, name: "Grive mauvis", images: [
  ...
  { id: 53, name: "Merle à plastron", images: [
  ...
  { id: 54, name: "Faucon crécerelle", images: [
  ...
  { id: 55, name: "Buse variable", images: [
  ...
  { id: 56, name: "Épervier d'Europe", images: [
  ...
  { id: 59, name: "Busard Saint-Martin", images: [
  ...
  { id: 60, name: "Busard cendré", images: [
  ...
  { id: 61, name: "Bondrée apivore", images: [
  ...
  { id: 62, name: "Autour des palombes", images: [
  ...
  { id: 63, name: "Faucon hobereau", images: [
